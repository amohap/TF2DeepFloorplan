...
def parse_args(args: List[str]) -> argparse.Namespace:
    ...
    p.add_argument("--act_0", type=str)
    p.add_argument("--act_1", type=str)
    p.add_argument("--act_2", type=str)
    p.add_argument("--act_3", type=str)
    p.add_argument("--plot_path", type=str, default="dfp/plots")
