...
def parse_args(args: List[str]) -> argparse.Namespace:
    ...
    p.add_argument("--logdir", type=str, default="/cluster/scratch/amohap/data/tf2deep/log/store")
    p.add_argument("--modeldir", type=str, default="/cluster/scratch/amohap/data/tf2deep/model/store")
